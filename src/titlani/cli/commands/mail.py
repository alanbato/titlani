...
@mail_app.command("list-create")
def mail_list_create(
    ...
    try:
        ...
        console.print(
            f"[dim]Add subscribers with: titlani mail list-add {listname} <address>[/]"
        )
    except OSError as e:
...
@mail_app.command("list-subscribers")
def mail_list_subscribers(
...
@mail_app.command("list-remove")
def mail_list_remove(
    listname: str = typer.Argument(..., help="Mailing list name"),
